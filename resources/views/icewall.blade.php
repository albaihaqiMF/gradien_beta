...
<html lang="en" class="light">
    ...
    <body class="main">
        ...
        <div class="mobile-menu md:hidden">
            ...
            <ul class="hidden py-5 border-t border-theme-2">
                <li>
                    <a href="javascript:;.html" class="menu menu--active">
                        <div class="menu__icon"> <i data-feather="home"></i> </div>
                        <div class="menu__title"> Dashboard <i data-feather="chevron-down" class="transform rotate-180 menu__sub-icon"></i> </div>
                    </a>
        ...
        <div class="px-3 mb-12 -mx-3 border-b top-bar-boxed border-theme-2 -mt-7 md:-mt-5 sm:-mx-8 sm:px-8 md:pt-0">
            <div class="flex items-center h-full">
                ...
                <!-- END: Logo -->
                <!-- BEGIN: Breadcrumb -->
                <div class="mr-auto -intro-x breadcrumb"> <a href="">Application</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Dashboard</a> </div>
                <!-- END: Breadcrumb -->
                <!-- BEGIN: Search -->
                <div class="relative mr-3 intro-x sm:mr-6">
                    <div class="hidden search sm:block">
                        <input type="text" class="border-transparent search__input form-control dark:bg-dark-1 placeholder-theme-8" placeholder="Search...">
                        ...
                        <div class="search-result__content">
                            ...
                            <div class="mb-5">
                                <a href="" class="flex items-center">
                                    <div class="flex items-center justify-center w-8 h-8 rounded-full bg-theme-29 text-theme-10"> <i class="w-4 h-4" data-feather="inbox"></i> </div>
                                    <div class="ml-3">Mail Settings</div>
                                </a>
                                <a href="" class="flex items-center mt-2">
                                    <div class="flex items-center justify-center w-8 h-8 rounded-full bg-theme-30 text-theme-24"> <i class="w-4 h-4" data-feather="users"></i> </div>
                                    <div class="ml-3">Users & Permissions</div>
                                </a>
                                <a href="" class="flex items-center mt-2">
                                    <div class="flex items-center justify-center w-8 h-8 rounded-full bg-theme-31 text-theme-26"> <i class="w-4 h-4" data-feather="credit-card"></i> </div>
                ...
                <div class="mr-4 intro-x dropdown sm:mr-6">
                    <div class="cursor-pointer dropdown-toggle notification notification--bullet" role="button" aria-expanded="false"> <i data-feather="bell" class="notification__icon dark:text-gray-300"></i> </div>
                ...
                <div class="w-8 h-8 intro-x dropdown">
                    ...
                    <div class="w-56 dropdown-menu">
                        <div class="text-white dropdown-menu__content box bg-theme-11 dark:bg-dark-6">
                            ...
                            <div class="p-2">
                                <a href="" class="flex items-center block p-2 transition duration-300 ease-in-out rounded-md hover:bg-theme-1 dark:hover:bg-dark-3"> <i data-feather="user" class="w-4 h-4 mr-2"></i> Profile </a>
                                <a href="" class="flex items-center block p-2 transition duration-300 ease-in-out rounded-md hover:bg-theme-1 dark:hover:bg-dark-3"> <i data-feather="edit" class="w-4 h-4 mr-2"></i> Add Account </a>
                                <a href="" class="flex items-center block p-2 transition duration-300 ease-in-out rounded-md hover:bg-theme-1 dark:hover:bg-dark-3"> <i data-feather="lock" class="w-4 h-4 mr-2"></i> Reset Password </a>
                                <a href="" class="flex items-center block p-2 transition duration-300 ease-in-out rounded-md hover:bg-theme-1 dark:hover:bg-dark-3"> <i data-feather="help-circle" class="w-4 h-4 mr-2"></i> Help </a>
                            </div>
                            <div class="p-2 border-t border-theme-12 dark:border-dark-3">
                                <a href="" class="flex items-center block p-2 transition duration-300 ease-in-out rounded-md hover:bg-theme-1 dark:hover:bg-dark-3"> <i data-feather="toggle-right" class="w-4 h-4 mr-2"></i> Logout </a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <li>
                            <a href="javascript:;.html" class="side-menu side-menu--active">
                                ...
                                <div class="side-menu__title">
                                    Dashboard
                                    <div class="transform rotate-180 side-menu__sub-icon"> <i data-feather="chevron-down"></i> </div>
                                </div>
                            </a>
                ...
                <div class="content">
                    <div class="grid grid-cols-12 gap-6">
                        <div class="col-span-12 2xl:col-span-9">
                            <div class="grid grid-cols-12 gap-6">
                                ...
                                <div class="col-span-12 mt-6 -mb-6 intro-y">
                                    <div class="flex items-center mb-6 text-white alert alert-dismissible show box bg-theme-26" role="alert">
                                        <span>Introducing new dashboard! Download now at <a href="https://themeforest.net/item/midone-jquery-tailwindcss-html-admin-template/26366820" class="ml-1 underline" target="blank">themeforest.net</a>.</span>
                                ...
                                <div class="col-span-12 mt-2 lg:col-span-8 xl:col-span-6">
                                    <div class="items-center block h-10 intro-y sm:flex">
                                        ...
                                        <select class="mt-3 sm:ml-auto sm:mt-0 sm:w-auto form-select box">
                                    ...
                                    <div class="mt-12 report-box-2 intro-y sm:mt-5">
                                        <div class="box sm:flex">
                                            <div class="flex flex-col justify-center flex-1 px-8 py-12">
                                                ...
                                                <div class="cursor-pointer report-box-2__indicator bg-theme-10 tooltip" title="47% Higher than last month"> 47% <i data-feather="chevron-up" class="w-4 h-4 ml-0.5"></i> </div>
                                                <div class="mt-4 text-gray-600 dark:text-gray-600">Sales earnings this month after associated author fees, & before taxes.</div>
                                                <button class="relative justify-start mt-12 rounded-full btn btn-outline-secondary">
                                                    Download Reports
                                            ...
                                            <div class="flex flex-col justify-center flex-1 px-8 py-12 border-t border-gray-300 border-dashed sm:border-t-0 sm:border-l dark:border-dark-5">
                                                <div class="text-xs text-gray-600 dark:text-gray-600">TOTAL TRANSACTION</div>
                                                <div class="mt-1.5 flex items-center">
                                                    <div class="text-base">4.501</div>
                                                    <div class="flex ml-2 text-xs font-medium cursor-pointer text-theme-24 tooltip" title="2% Lower than last month"> 2% <i data-feather="chevron-down" class="w-4 h-4 ml-0.5"></i> </div>
                                                </div>
                                                <div class="mt-5 text-xs text-gray-600 dark:text-gray-600">CANCELATION CASE</div>
                                                <div class="mt-1.5 flex items-center">
                                                    <div class="text-base">2</div>
                                                    <div class="flex ml-2 text-xs font-medium cursor-pointer text-theme-24 tooltip" title="0.1% Lower than last month"> 0.1% <i data-feather="chevron-down" class="w-4 h-4 ml-0.5"></i> </div>
                                                </div>
                                                <div class="mt-5 text-xs text-gray-600 dark:text-gray-600">GROSS RENTAL VALUE</div>
                                                <div class="mt-1.5 flex items-center">
                                                    <div class="text-base">$72.000</div>
                                                    <div class="flex ml-2 text-xs font-medium cursor-pointer text-theme-10 tooltip" title="49% Higher than last month"> 49% <i data-feather="chevron-up" class="w-4 h-4 ml-0.5"></i> </div>
                                                </div>
                                                <div class="mt-5 text-xs text-gray-600 dark:text-gray-600">GROSS RENTAL PROFIT</div>
                                                <div class="mt-1.5 flex items-center">
                                                    <div class="text-base">$54.000</div>
                                                    <div class="flex ml-2 text-xs font-medium cursor-pointer text-theme-10 tooltip" title="52% Higher than last month"> 52% <i data-feather="chevron-up" class="w-4 h-4 ml-0.5"></i> </div>
                                                </div>
                                                <div class="mt-5 text-xs text-gray-600 dark:text-gray-600">NEW USERS</div>
                                                <div class="mt-1.5 flex items-center">
                                ...
                                <div class="col-span-12 mt-2 sm:col-span-6 lg:col-span-4 xl:col-span-3">
                                    <div class="flex items-center h-10 intro-y">
                                        ...
                                        <a href="" class="ml-auto truncate text-theme-26 dark:text-theme-33">View on Map</a>
                                    </div>
                                        ...
                                        <div class="p-5 box">
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-auto dropdown">
                                                    <a class="block w-5 h-5 -mr-2 dropdown-toggle" href="javascript:;" aria-expanded="false"> <i data-feather="more-vertical" class="w-5 h-5 text-gray-600 dark:text-gray-300"></i> </a>
                                                    <div class="w-40 dropdown-menu">
                                                        <div class="p-2 dropdown-menu__content box dark:bg-dark-1">
                                                            <a href="" class="flex items-center block p-2 transition duration-300 ease-in-out bg-white rounded-md dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2"> <i data-feather="file-text" class="w-4 h-4 mr-2"></i> Export </a>
                                                            <a href="" class="flex items-center block p-2 transition duration-300 ease-in-out bg-white rounded-md dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2"> <i data-feather="settings" class="w-4 h-4 mr-2"></i> Settings </a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="mt-2 text-2xl font-medium">214</div>
                                            <div class="flex pb-2 mt-4 border-b border-gray-200">
                                                <div class="text-xs text-gray-600 dark:text-gray-600">Page views per second</div>
                                                <div class="flex ml-auto text-xs font-medium cursor-pointer text-theme-10 tooltip" title="49% Lower than last month"> 49% <i data-feather="chevron-up" class="w-4 h-4 ml-0.5"></i> </div>
                                            </div>
                                            ...
                                            <div class="flex pb-2 mt-4 mb-2 text-xs text-gray-600 border-b border-gray-200 dark:text-gray-600">
                                            ...
                                            <button class="w-full px-2 py-1 mt-4 border-dashed btn btn-outline-secondary">Real-Time Report</button>
                                        </div>
                                    </div>
                                </div>
                                <!-- END: Visitors -->
                                <!-- BEGIN: Users By Age -->
                                <div class="col-span-12 mt-2 sm:col-span-6 lg:col-span-4 xl:col-span-3 lg:mt-6 xl:mt-2">
                                    <div class="flex items-center h-10 intro-y">
                                        <h2 class="mr-5 text-lg font-medium truncate">
                                            Users By Age
                                        </h2>
                                        <a href="" class="ml-auto truncate text-theme-26 dark:text-theme-33">Show More</a>
                                    </div>
                                    <div class="mt-5 report-box-2 intro-y">
                                        <div class="p-5 box">
                                            <div class="justify-center w-4/5 mx-auto text-gray-600 bg-gray-200 rounded-md boxed-tabs nav nav-tabs dark:bg-dark-1 dark:text-gray-500" role="tablist"> <a data-toggle="tab" data-target="#active-users" href="javascript:;" class="btn flex-1 border-0 shadow-none py-1.5 px-2 active" id="active-users-tab" role="tab" aria-controls="active-users" aria-selected="true">Active</a> <a data-toggle="tab" data-target="#inactive-users" href="javascript:;" class="btn flex-1 border-0 shadow-none py-1.5 px-2" id="inactive-users-tab" role="tab" aria-selected="false">Inactive</a> </div>
                                            <div class="mt-6 tab-content">
                                                <div class="tab-pane active" id="active-users" role="tabpanel" aria-labelledby="active-users-tab">
                                                    ...
                                                    <div class="mt-5">
                                                        <div class="flex items-center">
                                                            <div class="w-2 h-2 mr-3 rounded-full bg-theme-17"></div>
                                                            <span class="truncate">17 - 30 Years old</span>
                                                            <div class="flex-1 h-px mx-3 border border-r border-gray-300 border-dashed xl:hidden"></div>
                                                            <span class="font-medium xl:ml-auto">62%</span>
                                                        </div>
                                                        <div class="flex items-center mt-4">
                                                            <div class="w-2 h-2 mr-3 rounded-full bg-theme-35"></div>
                                                            <span class="truncate">31 - 50 Years old</span>
                                                            <div class="flex-1 h-px mx-3 border border-r border-gray-300 border-dashed xl:hidden"></div>
                                                            <span class="font-medium xl:ml-auto">33%</span>
                                                        </div>
                                                        <div class="flex items-center mt-4">
                                                            <div class="w-2 h-2 mr-3 rounded-full bg-theme-23"></div>
                                ...
                                <div class="col-span-12 mt-6 lg:col-span-8">
                                    <div class="items-center block h-10 intro-y sm:flex">
                                        ...
                                        <div class="relative mt-3 text-gray-700 sm:ml-auto sm:mt-0 dark:text-gray-300">
                                            <i data-feather="map-pin" class="absolute inset-y-0 left-0 z-10 w-4 h-4 my-auto ml-3"></i>
                                            <input type="text" class="pl-10 form-control sm:w-40 box" placeholder="Filter by city">
                                        </div>
                                    </div>
                                    <div class="p-5 mt-12 intro-y box sm:mt-5">
                                        <div>250 Official stores in 21 countries, click the marker to see location details.</div>
                                        <div class="mt-5 bg-gray-200 rounded-md report-maps" data-center="-6.2425342, 106.8626478" data-sources="//json/location.json"></div>
                                    </div>
                                </div>
                                <!-- END: Official Store -->
                                    ...
                                    <div class="mt-5">
                                        <div class="intro-y">
                                            <div class="flex items-center px-4 py-4 mb-3 box zoom-in">
                                                ...
                                                <div class="ml-4 mr-auto">
                                                    ...
                                                    <div class="text-gray-600 text-xs mt-0.5">12 December 2020</div>
                                                </div>
                                                <div class="px-2 py-1 text-xs font-medium text-white rounded-full cursor-pointer bg-theme-10">137 Sales</div>
                                            </div>
                                        </div>
                                        <div class="intro-y">
                                            <div class="flex items-center px-4 py-4 mb-3 box zoom-in">
                                                ...
                                                <div class="ml-4 mr-auto">
                                                    <div class="font-medium">Denzel Washington</div>
                                                    <div class="text-gray-600 text-xs mt-0.5">19 December 2021</div>
                                                </div>
                                                <div class="px-2 py-1 text-xs font-medium text-white rounded-full cursor-pointer bg-theme-10">137 Sales</div>
                                            </div>
                                        </div>
                                        <div class="intro-y">
                                            <div class="flex items-center px-4 py-4 mb-3 box zoom-in">
                                                ...
                                                <div class="ml-4 mr-auto">
                                                    ...
                                                    <div class="text-gray-600 text-xs mt-0.5">8 June 2022</div>
                                                </div>
                                                <div class="px-2 py-1 text-xs font-medium text-white rounded-full cursor-pointer bg-theme-10">137 Sales</div>
                                            </div>
                                        </div>
                                        <div class="intro-y">
                                            <div class="flex items-center px-4 py-4 mb-3 box zoom-in">
                                                ...
                                                <div class="ml-4 mr-auto">
                                                    <div class="font-medium">Denzel Washington</div>
                                                    <div class="text-gray-600 text-xs mt-0.5">5 August 2022</div>
                                                </div>
                                                <div class="px-2 py-1 text-xs font-medium text-white rounded-full cursor-pointer bg-theme-10">137 Sales</div>
                                            </div>
                                        </div>
                                        <a href="" class="block w-full py-4 text-center border border-dotted rounded-md intro-y border-theme-27 dark:border-dark-5 text-theme-28 dark:text-gray-600">View More</a>
                                    </div>
                                </div>
                                <!-- END: Weekly Best Sellers -->
                                <!-- BEGIN: Ads 1 -->
                                <div class="col-span-12 mt-6 lg:col-span-6">
                                    <div class="relative p-8 overflow-hidden ads-box box bg-theme-17 intro-y">
                                ...
                                <!-- BEGIN: Ads 2 -->
                                <div class="col-span-12 mt-6 lg:col-span-6">
                                    <div class="relative p-8 overflow-hidden ads-box box intro-y">
                                        <div class="w-full -mt-3 text-xl ads-box__title sm:w-52 text-theme-17 dark:text-white">Invite friends to get <span class="font-medium">FREE</span> bonuses!</div>
                                ...
                                <div class="col-span-12 mt-6">
                                    <div class="items-center block h-10 intro-y sm:flex">
                                        ...
                                        <div class="flex items-center mt-3 sm:ml-auto sm:mt-0">
                                            <button class="flex items-center text-gray-700 btn box dark:text-gray-300"> <i data-feather="file-text" class="hidden w-4 h-4 mr-2 sm:block"></i> Export to Excel </button>
                                            <button class="flex items-center ml-3 text-gray-700 btn box dark:text-gray-300"> <i data-feather="file-text" class="hidden w-4 h-4 mr-2 sm:block"></i> Export to PDF </button>
                                        </div>
                                    </div>
                        ...
                        <div class="col-span-12 2xl:col-span-3">
                            <div class="pb-10 -mb-10 2xl:border-l border-theme-25">
                                <div class="grid grid-cols-12 gap-6 2xl:pl-6">
                                    ...
                                    <div class="col-span-12 mt-3 md:col-span-6 xl:col-span-12 2xl:mt-8">
                                        <div class="flex items-center h-10 intro-x">
                                            ...
                                            <button data-carousel="important-notes" data-target="prev" class="px-2 mr-2 text-gray-700 border-gray-400 tiny-slider-navigator btn dark:text-gray-300"> <i data-feather="chevron-left" class="w-4 h-4"></i> </button>
                                            <button data-carousel="important-notes" data-target="next" class="px-2 mr-2 text-gray-700 border-gray-400 tiny-slider-navigator btn dark:text-gray-300"> <i data-feather="chevron-right" class="w-4 h-4"></i> </button>
                                        </div>
                                            ...
                                            <div class="box zoom-in">
                                                <div class="tiny-slider" id="important-notes">
                                                    <div class="p-5">
                                                        ...
                                                        <div class="mt-1 text-justify text-gray-600">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</div>
                                        ...
                                        <div class="relative mt-5 report-timeline">
                                            ...
                                            <div class="relative flex items-center mb-3 intro-x">
                                                ...
                                                <div class="flex-1 px-5 py-3 ml-4 box zoom-in">
                                                    ...
                                                    <div class="mt-1 text-gray-600">Has changed <a class="text-theme-12 dark:text-gray-300" href="">Sony A7 III</a> price and description</div>
                                                </div>
                                            </div>
                                            <div class="relative flex items-center mb-3 intro-x">
                                                <div class="report-timeline__image">
                                                ...
                                                <div class="flex-1 px-5 py-3 ml-4 box zoom-in">
                                                    ...
                                                    <div class="mt-1 text-gray-600">Has changed <a class="text-theme-12 dark:text-gray-300" href="">Oppo Find X2 Pro</a> description</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="mt-5">
                                            <div class="intro-x">
                                                <div class="flex items-center px-5 py-3 mb-3 box zoom-in">
                                                    ...
                                                    <div class="text-theme-24">+$68</div>
                                                </div>
                                            </div>
                                            <div class="intro-x">
                                                <div class="flex items-center px-5 py-3 mb-3 box zoom-in">
                                            ...
                                            <div class="intro-x">
                                                <div class="flex items-center px-5 py-3 mb-3 box zoom-in">
                                                    ...
                                                    <div class="text-theme-24">+$79</div>
                                                </div>
                                            </div>
                                            <div class="intro-x">
                                                <div class="flex items-center px-5 py-3 mb-3 box zoom-in">
                                                    ...
                                                    <div class="ml-4 mr-auto">
                                                        <div class="font-medium">Russell Crowe</div>
                                                        <div class="text-gray-600 text-xs mt-0.5">11 April 2021</div>
                                                    </div>
                                                    <div class="text-theme-24">+$73</div>
                                                </div>
                                            </div>
                                            <a href="" class="block w-full py-3 text-center border border-dotted rounded-md intro-x border-theme-27 dark:border-dark-5 text-theme-28 dark:text-gray-600">View More</a>
                                        </div>
                                    </div>
                                    <!-- END: Transactions -->
                                    <!-- BEGIN: Schedules -->
                                    <div class="col-span-12 mt-3 md:col-span-6 xl:col-span-4 2xl:col-span-12 xl:col-start-1 xl:row-start-2 2xl:col-start-auto 2xl:row-start-auto">
                                        <div class="flex items-center h-10 intro-x">
                                            ...
                                            <a href="" class="flex items-center ml-auto truncate text-theme-26 dark:text-gray-400"> <i data-feather="plus" class="w-4 h-4 mr-1"></i> Add New Schedules </a>
                                        </div>
                                        <div class="mt-5">
                                            <div class="intro-x box">
                                                ...
                                                <div class="p-5 border-t border-gray-200 dark:border-dark-5">
                                                    <div class="flex items-center">
                                                        <div class="w-2 h-2 mr-3 rounded-full bg-theme-22"></div>
                                                        <span class="truncate">UI/UX Workshop</span>
                                                        <div class="flex-1 h-px mx-3 border border-r border-gray-300 border-dashed xl:hidden"></div>
                                                        <span class="font-medium xl:ml-auto">23th</span>
                                                    </div>
                                                    <div class="flex items-center mt-4">
                                                        <div class="w-2 h-2 mr-3 rounded-full bg-theme-26 dark:bg-theme-10"></div>
        ...
        <div data-url="side-menu-dark-dashboard-overview-1.html" class="fixed bottom-0 right-0 z-50 flex items-center justify-center w-40 h-12 mb-10 mr-10 border rounded-full shadow-md cursor-pointer dark-mode-switcher box dark:bg-dark-2">
